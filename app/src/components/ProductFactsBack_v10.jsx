...
const COLORS = {
  ...
  whatItDoes:     "#ff6eb0",   // Light pink     — WHAT IT DOES
...
const sampleProduct = {
  ...
  sections: {
    ...
    is: {
      keyIngredients: [
        { label: "Castor Seed Oil",              inci: "Ricinus Communis Seed Oil",          slug: "castor-seed-oil",              tooltip: "Ricinus Communis Seed Oil — Emollient base. Gives the formula its glide." },
        { label: "Jojoba Oil",                   inci: "Simmondsia Chinensis Seed Oil",       slug: "jojoba-oil",                   tooltip: "Simmondsia Chinensis Seed Oil — Wax ester that mimics skin's own sebum." },
        { label: "Caprylic/Capric Triglyceride", inci: "Caprylic/Capric Triglyceride",        slug: "caprylic-capric-triglyceride", tooltip: "Lightweight emollient from coconut oil. Helps spread formula evenly." },
      ],
      allIngredients: [
    ...
    deal: {
      ...
      priceTier: "Accessible",
      retailers: [
        { label: "Credo Beauty", url: "https://www.credobeauty.com/?awinmid=XXXXX&awinaffid=XXXXX", tooltip: "Ships free over $50. Credo Clean Standard verified.", active: true },
        { label: "Tower 28 Direct", url: "", tooltip: "Buy direct from the brand. Subscribe & save 15%.", active: false },
        { label: "Sephora", url: "", tooltip: "In-store and online. Free samples with orders.", active: false },
      ],
    ...
    return (
      <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
        ...
        <div>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 4 }}>
            {data.finish.map((f, i) => (
              <Pill key={i} label={f.label} color={COLORS.whatItDoes} tooltip={f.tooltip} />
            ))}
          </div>
        </div>
        <div>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 4 }}>
            {data.coverage.map((c, i) => (
              <Pill key={i} label={c.label} color={COLORS.whatItDoes} tooltip={c.tooltip} />
            ))}
          </div>
        </div>
      </div>
  ...
  if (sectionKey === "is") {
    ...
    return (
      <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
        ...
        {/* Key Ingredients — AQUA hover tooltip pills */}
        <div>
          <SubLabel text="Key Ingredients" />
          <div style={{ display: "flex", flexWrap: "wrap", gap: 4 }}>
            {data.keyIngredients.map((ing, i) => (
              <Pill key={i} label={ing.label} color={COLORS.ingredients} tooltip={ing.tooltip} />
            ))}
          </div>

          {/* See All Ingredients rabbit hole link */}
          <div
          ...
          {showAll && (
            <div style={{
              ...
              gap: 4,
              paddingLeft: 4,
              borderLeft: `2px solid ${COLORS.ingredients}40`,
            }}>
          ...
          {data.retailers.map((r, i) => {
              ...
              return (
                <a
                  ...
                  style={{
                    ...
                    padding: "2px",
                    borderRadius: 10,
                    background: "linear-gradient(90deg, #ffaa00, #ff8c2a, #ff5533, #ff4466, #ff4d8a, #d946ef, #9955ff, #3399ff, #44ddee, #00c4b0)",
                    textDecoration: "none",
                  }}
                >
                  <div style={{
                    ...
                    <span style={{
                      ...
                      fontSize: ".8rem",
                      fontWeight: 700,
                      color: COLORS.whatsTheDeal,
                    }}>
                      👜 {r.label}
                    </span>
                    <span style={{ fontSize: 12, color: COLORS.whatsTheDeal }}>→</span>
                  </div>
                </a>
              );
            }
            return (
              ...
              >
                ...
                <span style={{ fontSize: 11, color: "rgba(255,255,255,.2)" }}>coming soon</span>
              </div>
            );
          })}
        </div>
  ...
  return (
    <div style={{ borderTop: `1px solid ${COLORS.divider}` }}>
      ...
      >
        ...
        <span style={{
          fontSize: 8,
          color: isOpen ? section.color : "rgba(255,255,255,.5)",
      ...
      <div style={{ padding: "10px 16px 8px" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
          <div style={{ flex: 1 }}>
            ...
            {/* Thick rule — directly under Product Facts */}
            <div style={{ height: 2, background: "#ffffff", marginBottom: 8 }} />
